...
import { GetMyTaskListRequest } from './MyTaskListService';
...
export default function MyTaskList(){
    ...
    const getMyTaskList = async () => {
        ...
        await GetMyTaskListRequest(cookies.user_token, false).then((results)=>{
    ...
    return (
        <div id="my-task-list-page" className="page-content">
            {showLoading ? <Loading /> : '' }
